...
public class PureSandBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:pure_sand")
	public static final Block block = null;
	public PureSandBlock(NfmModElements instance) {
		super(instance, 9);
	}
