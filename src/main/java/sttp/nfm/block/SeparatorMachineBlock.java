...
import sttp.nfm.gui.SeparatorMachineGUIGui;
...
public class SeparatorMachineBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:separator_machine")
	public static final Block block = null;
	public SeparatorMachineBlock(NfmModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("separator_machine");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Separator Machine");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SeparatorMachineGUIGui.GuiContainerMod(id, inventory,
