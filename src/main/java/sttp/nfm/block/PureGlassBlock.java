...
public class PureGlassBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:pure_glass")
	public static final Block block = null;
	public PureGlassBlock(NfmModElements instance) {
		super(instance, 10);
	}
