...
public class RedAlpinia2Block extends NfmModElements.ModElement {
	@ObjectHolder("nfm:red_alpinia_2")
	public static final Block block = null;
	public RedAlpinia2Block(NfmModElements instance) {
		super(instance, 29);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_alpinia_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nfm:red_alpinia_2"), configuredFeature);
		}
	}
	@SubscribeEvent
