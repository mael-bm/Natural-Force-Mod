...
public class WoodenFloorBricksBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:wooden_floor_bricks")
	public static final Block block = null;
	public WoodenFloorBricksBlock(NfmModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wooden_floor_bricks");
		}
