...
public class RedAlpinia1Block extends NfmModElements.ModElement {
	@ObjectHolder("nfm:red_alpinia_1")
	public static final Block block = null;
	public RedAlpinia1Block(NfmModElements instance) {
		super(instance, 28);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_alpinia_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("nfm:red_alpinia_1"), configuredFeature);
		}
	}
	@SubscribeEvent
