...
public class CompactedCobblestoneBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:compacted_cobblestone")
	public static final Block block = null;
	public CompactedCobblestoneBlock(NfmModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compacted_cobblestone");
		}
