...
import sttp.nfm.gui.FusionMachineGUIGui;
...
public class FusionMachineBlock extends NfmModElements.ModElement {
	@ObjectHolder("nfm:fusion_machine")
	public static final Block block = null;
	public FusionMachineBlock(NfmModElements instance) {
		super(instance, 21);
	}
